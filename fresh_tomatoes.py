...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .rating_wrapper {
            /* contains 1 imdb icon and 5 stars, each 16px wide */
            width: 96px;
            height: 16px;
            /* center the rating bar */
            margin: 10px auto;
        }
        .imdb_icon {
            float: left;
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <div class="rating_wrapper">
        <img class="imdb_icon" src="images/IMDb_favicon.png">
        <div class="rating_bar">
            <div class="rating" style="width:{star_width}%;"></div>
        </div>
    </div>
</div>
'''
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        content += movie_tile_content.format(
            ...
            # star_width is the percent of filled stars. For example, a movie with an IMDb rating of 6/10 will have 60% of the stars filled.  
            star_width = movie.imdb_rating*10
        )
    return content
